              ...
              <div key={i} className={cn('flex items-start gap-3 rounded-xl border px-3 py-2.5', SEV_COLOR[v.severity])}>
                ...
                <div className="min-w-0">
                  <div className="flex items-center gap-2 mb-0.5">
                    ...
                    {v.cvss_score != null && (
                      <span className="text-[10px] font-semibold opacity-70">CVSS {v.cvss_score.toFixed(1)}</span>
                    )}
                  ...
                  {v.fix && (
                    <div className="mt-2 rounded-lg bg-black/5 px-2.5 py-1.5">
                      <span className="text-[10px] font-bold uppercase tracking-wider opacity-50">Fix · </span>
                      <span className="text-xs opacity-80">{v.fix}</span>
                    </div>
                  )}
                </div>
              </div>
